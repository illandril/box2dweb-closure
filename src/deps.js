...
goog.addDependency('../../../src/collision/shapes/b2CircleShape.js', ['Box2D.Collision.Shapes.b2CircleShape'], ['UsageTracker', 'Box2D.Collision.Shapes.b2Shape', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/shapes/b2EdgeChainDef.js', ['Box2D.Collision.Shapes.b2EdgeChainDef'], ['UsageTracker']);
goog.addDependency('../../../src/collision/shapes/b2EdgeShape.js', ['Box2D.Collision.Shapes.b2EdgeShape'], ['UsageTracker', 'Box2D.Collision.Shapes.b2Shape', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/shapes/b2MassData.js', ['Box2D.Collision.Shapes.b2MassData'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/shapes/b2PolygonShape.js', ['Box2D.Collision.Shapes.b2PolygonShape'], ['UsageTracker', 'Box2D.Collision.Shapes.b2MassData', 'Box2D.Collision.Shapes.b2Shape', 'Box2D.Common.Math.b2Mat22', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Transform', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/shapes/b2Shape.js', ['Box2D.Collision.Shapes.b2Shape'], ['UsageTracker', 'Box2D.Collision.b2Distance', 'Box2D.Collision.b2DistanceInput', 'Box2D.Collision.b2DistanceOutput', 'Box2D.Collision.b2DistanceProxy', 'Box2D.Collision.b2SimplexCache']);
...
goog.addDependency('../../../src/dynamics/b2Island.js', ['Box2D.Dynamics.b2Island'], ['UsageTracker', 'Box2D.Common.Math.b2Math', 'Box2D.Common.b2Settings', 'Box2D.Dynamics.b2BodyDef', 'Box2D.Dynamics.b2ContactImpulse']);
...
goog.addDependency('../../../src/dynamics/contacts/b2ContactConstraint.js', ['Box2D.Dynamics.Contacts.b2ContactConstraint'], ['UsageTracker', 'Box2D.Common.Math.b2Mat22', 'Box2D.Common.Math.b2Vec2', 'Box2D.Dynamics.Contacts.b2ContactConstraintPoint']);
goog.addDependency('../../../src/dynamics/contacts/b2ContactConstraintPoint.js', ['Box2D.Dynamics.Contacts.b2ContactConstraintPoint'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
