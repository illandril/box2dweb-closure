...
goog.addDependency('../../../src/collision/ClipVertex.js', ['Box2D.Collision.ClipVertex'], ['UsageTracker', 'Box2D.Collision.b2ContactID', 'Box2D.Common.Math.b2Vec2']);
...
goog.addDependency('../../../src/collision/b2DistanceOutput.js', ['Box2D.Collision.b2DistanceOutput'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2DistanceProxy.js', ['Box2D.Collision.b2DistanceProxy'], ['UsageTracker', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2DynamicTree.js', ['Box2D.Collision.b2DynamicTree'], ['UsageTracker', 'Box2D.Collision.b2AABB', 'Box2D.Collision.b2DynamicTreeNode', 'Box2D.Collision.b2RayCastInput', 'Box2D.Common.Math.b2Math', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2DynamicTreeBroadPhase.js', ['Box2D.Collision.b2DynamicTreeBroadPhase'], ['UsageTracker', 'Box2D.Collision.IBroadPhase', 'Box2D.Collision.b2DynamicTree', 'Box2D.Collision.b2DynamicTreePair', 'goog.array']);
goog.addDependency('../../../src/collision/b2DynamicTreeNode.js', ['Box2D.Collision.b2DynamicTreeNode'], ['UsageTracker', 'Box2D.Collision.b2AABB']);
goog.addDependency('../../../src/collision/b2DynamicTreePair.js', ['Box2D.Collision.b2DynamicTreePair'], ['UsageTracker']);
goog.addDependency('../../../src/collision/b2Manifold.js', ['Box2D.Collision.b2Manifold'], ['UsageTracker', 'Box2D.Collision.b2ManifoldPoint', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2ManifoldPoint.js', ['Box2D.Collision.b2ManifoldPoint'], ['UsageTracker', 'Box2D.Collision.b2ContactID', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2RayCastInput.js', ['Box2D.Collision.b2RayCastInput'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2RayCastOutput.js', ['Box2D.Collision.b2RayCastOutput'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2Segment.js', ['Box2D.Collision.b2Segment'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2SeparationFunction.js', ['Box2D.Collision.b2SeparationFunction'], ['UsageTracker', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2Simplex.js', ['Box2D.Collision.b2Simplex'], ['UsageTracker', 'Box2D.Collision.b2SimplexVertex', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
...
goog.addDependency('../../../src/collision/b2TOIInput.js', ['Box2D.Collision.b2TOIInput'], ['UsageTracker', 'Box2D.Collision.b2DistanceProxy', 'Box2D.Common.Math.b2Sweep']);
...
goog.addDependency('../../../src/collision/b2WorldManifold.js', ['Box2D.Collision.b2WorldManifold'], ['UsageTracker', 'Box2D.Collision.b2Manifold', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
...
goog.addDependency('../../../src/common/b2Color.js', ['Box2D.Common.b2Color'], ['UsageTracker', 'Box2D.Common.Math.b2Math']);
goog.addDependency('../../../src/common/b2Settings.js', ['Box2D.Common.b2Settings'], []);
goog.addDependency('../../../src/common/math/b2Mat22.js', ['Box2D.Common.Math.b2Mat22'], ['UsageTracker', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/common/math/b2Mat33.js', ['Box2D.Common.Math.b2Mat33'], ['UsageTracker', 'Box2D.Common.Math.b2Vec3']);
...
goog.addDependency('../../../src/dynamics/contacts/b2Contact.js', ['Box2D.Dynamics.Contacts.b2Contact'], ['Box2D.Collision.Shapes.b2Shape', 'Box2D.Collision.b2Manifold', 'Box2D.Collision.b2TOIInput', 'Box2D.Collision.b2TimeOfImpact', 'UsageTracker', 'Box2D.Common.b2Settings', 'Box2D.Dynamics.b2BodyDef']);
...
goog.addDependency('../../../src/dynamics/contacts/b2ContactFactory.js', ['Box2D.Dynamics.Contacts.b2ContactFactory'], ['UsageTracker', 'Box2D.Collision.Shapes.b2CircleShape', 'Box2D.Collision.Shapes.b2EdgeShape', 'Box2D.Collision.Shapes.b2PolygonShape', 'Box2D.Dynamics.Contacts.b2CircleContact', 'Box2D.Dynamics.Contacts.b2ContactRegister', 'Box2D.Dynamics.Contacts.b2EdgeAndCircleContact', 'Box2D.Dynamics.Contacts.b2PolyAndCircleContact', 'Box2D.Dynamics.Contacts.b2PolyAndEdgeContact', 'Box2D.Dynamics.Contacts.b2PolygonContact']);
