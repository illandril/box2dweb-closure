...
goog.addDependency('../../../src/collision/ClipVertex.js', ['Box2D.Collision.ClipVertex'], ['Box2D.Collision.b2ContactID', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/Features.js', ['Box2D.Collision.Features'], []);
...
goog.addDependency('../../../src/collision/b2ContactID.js', ['Box2D.Collision.b2ContactID'], ['Box2D.Collision.Features']);
goog.addDependency('../../../src/collision/b2ContactPoint.js', ['Box2D.Collision.b2ContactPoint'], ['Box2D.Collision.b2ContactID', 'Box2D.Common.Math.b2Vec2']);
...
goog.addDependency('../../../src/collision/b2DistanceInput.js', ['Box2D.Collision.b2DistanceInput'], []);
goog.addDependency('../../../src/collision/b2DistanceOutput.js', ['Box2D.Collision.b2DistanceOutput'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2DistanceProxy.js', ['Box2D.Collision.b2DistanceProxy'], ['Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2DynamicTree.js', ['Box2D.Collision.b2DynamicTree'], ['Box2D.Collision.b2AABB', 'Box2D.Collision.b2DynamicTreeNode', 'Box2D.Collision.b2RayCastInput', 'Box2D.Common.Math.b2Math', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2DynamicTreeBroadPhase.js', ['Box2D.Collision.b2DynamicTreeBroadPhase'], ['Box2D.Collision.IBroadPhase', 'Box2D.Collision.b2DynamicTree', 'Box2D.Collision.b2DynamicTreePair', 'goog.array']);
goog.addDependency('../../../src/collision/b2DynamicTreeNode.js', ['Box2D.Collision.b2DynamicTreeNode'], ['Box2D.Collision.b2AABB']);
goog.addDependency('../../../src/collision/b2DynamicTreePair.js', ['Box2D.Collision.b2DynamicTreePair'], []);
goog.addDependency('../../../src/collision/b2Manifold.js', ['Box2D.Collision.b2Manifold'], ['Box2D.Collision.b2ManifoldPoint', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2ManifoldPoint.js', ['Box2D.Collision.b2ManifoldPoint'], ['Box2D.Collision.b2ContactID', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2RayCastInput.js', ['Box2D.Collision.b2RayCastInput'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2RayCastOutput.js', ['Box2D.Collision.b2RayCastOutput'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2Segment.js', ['Box2D.Collision.b2Segment'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/b2SeparationFunction.js', ['Box2D.Collision.b2SeparationFunction'], ['Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2Simplex.js', ['Box2D.Collision.b2Simplex'], ['Box2D.Collision.b2SimplexVertex', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/b2SimplexCache.js', ['Box2D.Collision.b2SimplexCache'], []);
goog.addDependency('../../../src/collision/b2SimplexVertex.js', ['Box2D.Collision.b2SimplexVertex'], []);
goog.addDependency('../../../src/collision/b2TOIInput.js', ['Box2D.Collision.b2TOIInput'], ['Box2D.Collision.b2DistanceProxy', 'Box2D.Common.Math.b2Sweep']);
...
goog.addDependency('../../../src/collision/b2WorldManifold.js', ['Box2D.Collision.b2WorldManifold'], ['Box2D.Collision.b2Manifold', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/shapes/b2CircleShape.js', ['Box2D.Collision.Shapes.b2CircleShape'], ['Box2D.Collision.Shapes.b2Shape', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/shapes/b2EdgeChainDef.js', ['Box2D.Collision.Shapes.b2EdgeChainDef'], []);
goog.addDependency('../../../src/collision/shapes/b2EdgeShape.js', ['Box2D.Collision.Shapes.b2EdgeShape'], ['Box2D.Collision.Shapes.b2Shape', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/shapes/b2MassData.js', ['Box2D.Collision.Shapes.b2MassData'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/collision/shapes/b2PolygonShape.js', ['Box2D.Collision.Shapes.b2PolygonShape'], ['Box2D.Collision.Shapes.b2MassData', 'Box2D.Collision.Shapes.b2Shape', 'Box2D.Common.Math.b2Mat22', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Transform', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings']);
goog.addDependency('../../../src/collision/shapes/b2Shape.js', ['Box2D.Collision.Shapes.b2Shape'], ['Box2D.Collision.b2Distance', 'Box2D.Collision.b2DistanceInput', 'Box2D.Collision.b2DistanceOutput', 'Box2D.Collision.b2DistanceProxy', 'Box2D.Collision.b2SimplexCache']);
goog.addDependency('../../../src/common/b2Color.js', ['Box2D.Common.b2Color'], ['Box2D.Common.Math.b2Math']);
goog.addDependency('../../../src/common/b2Settings.js', ['Box2D.Common.b2Settings'], []);
goog.addDependency('../../../src/common/math/b2Mat22.js', ['Box2D.Common.Math.b2Mat22'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/common/math/b2Mat33.js', ['Box2D.Common.Math.b2Mat33'], ['Box2D.Common.Math.b2Vec3']);
goog.addDependency('../../../src/common/math/b2Math.js', ['Box2D.Common.Math.b2Math'], ['Box2D.Common.Math.b2Mat22', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/common/math/b2Sweep.js', ['Box2D.Common.Math.b2Sweep'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/common/math/b2Transform.js', ['Box2D.Common.Math.b2Transform'], ['Box2D.Common.Math.b2Mat22', 'Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/common/math/b2Vec2.js', ['Box2D.Common.Math.b2Vec2'], []);
goog.addDependency('../../../src/common/math/b2Vec3.js', ['Box2D.Common.Math.b2Vec3'], []);
goog.addDependency('../../../src/dynamics/b2Body.js', ['Box2D.Dynamics.b2Body'], ['Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Sweep', 'Box2D.Common.Math.b2Transform', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Settings', 'Box2D.Dynamics.b2BodyDef', 'Box2D.Dynamics.b2Fixture', 'Box2D.Dynamics.b2FixtureDef', 'Box2D.Dynamics.b2FixtureList']);
goog.addDependency('../../../src/dynamics/b2BodyDef.js', ['Box2D.Dynamics.b2BodyDef'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/dynamics/b2BodyList.js', ['Box2D.Dynamics.b2BodyList'], ['Box2D.Dynamics.b2BodyListNode', 'goog.array']);
goog.addDependency('../../../src/dynamics/b2BodyListNode.js', ['Box2D.Dynamics.b2BodyListNode'], []);
goog.addDependency('../../../src/dynamics/b2ContactFilter.js', ['Box2D.Dynamics.b2ContactFilter'], []);
goog.addDependency('../../../src/dynamics/b2ContactImpulse.js', ['Box2D.Dynamics.b2ContactImpulse'], []);
goog.addDependency('../../../src/dynamics/b2ContactListener.js', ['Box2D.Dynamics.b2ContactListener'], []);
goog.addDependency('../../../src/dynamics/b2ContactManager.js', ['Box2D.Dynamics.b2ContactManager'], ['Box2D.Collision.b2ContactPoint', 'Box2D.Collision.b2DynamicTreeBroadPhase', 'Box2D.Dynamics.Contacts.b2ContactFactory', 'Box2D.Dynamics.b2ContactFilter', 'Box2D.Dynamics.b2ContactListener']);
goog.addDependency('../../../src/dynamics/b2DebugDraw.js', ['Box2D.Dynamics.b2DebugDraw'], []);
goog.addDependency('../../../src/dynamics/b2DestructionListener.js', ['Box2D.Dynamics.b2DestructionListener'], []);
goog.addDependency('../../../src/dynamics/b2FilterData.js', ['Box2D.Dynamics.b2FilterData'], []);
goog.addDependency('../../../src/dynamics/b2Fixture.js', ['Box2D.Dynamics.b2Fixture'], ['Box2D.Collision.Shapes.b2MassData', 'Box2D.Collision.b2AABB', 'Box2D.Common.Math.b2Math', 'Box2D.Dynamics.b2FilterData']);
goog.addDependency('../../../src/dynamics/b2FixtureDef.js', ['Box2D.Dynamics.b2FixtureDef'], ['Box2D.Dynamics.b2FilterData']);
goog.addDependency('../../../src/dynamics/b2FixtureList.js', ['Box2D.Dynamics.b2FixtureList'], ['Box2D.Dynamics.b2FixtureListNode', 'goog.array']);
goog.addDependency('../../../src/dynamics/b2FixtureListNode.js', ['Box2D.Dynamics.b2FixtureListNode'], []);
goog.addDependency('../../../src/dynamics/b2Island.js', ['Box2D.Dynamics.b2Island'], ['Box2D.Common.Math.b2Math', 'Box2D.Common.b2Settings', 'Box2D.Dynamics.b2BodyDef', 'Box2D.Dynamics.b2ContactImpulse']);
goog.addDependency('../../../src/dynamics/b2TimeStep.js', ['Box2D.Dynamics.b2TimeStep'], []);
goog.addDependency('../../../src/dynamics/b2World.js', ['Box2D.Dynamics.b2World'], ['Box2D.Collision.Shapes.b2EdgeShape', 'Box2D.Collision.Shapes.b2Shape', 'Box2D.Collision.b2AABB', 'Box2D.Collision.b2RayCastInput', 'Box2D.Collision.b2RayCastOutput', 'Box2D.Common.Math.b2Math', 'Box2D.Common.Math.b2Sweep', 'Box2D.Common.Math.b2Transform', 'Box2D.Common.Math.b2Vec2', 'Box2D.Common.b2Color', 'Box2D.Dynamics.Contacts.b2ContactSolver', 'Box2D.Dynamics.Joints.b2DistanceJoint', 'Box2D.Dynamics.Joints.b2Joint', 'Box2D.Dynamics.Joints.b2MouseJoint', 'Box2D.Dynamics.Joints.b2PulleyJoint', 'Box2D.Dynamics.b2Body', 'Box2D.Dynamics.b2BodyDef', 'Box2D.Dynamics.b2BodyList', 'Box2D.Dynamics.b2ContactManager', 'Box2D.Dynamics.b2DebugDraw', 'Box2D.Dynamics.b2Island', 'Box2D.Dynamics.b2TimeStep', 'goog.structs.Queue']);
...
goog.addDependency('../../../src/dynamics/contacts/b2Contact.js', ['Box2D.Dynamics.Contacts.b2Contact'], ['Box2D.Collision.Shapes.b2Shape', 'Box2D.Collision.b2Manifold', 'Box2D.Collision.b2TOIInput', 'Box2D.Collision.b2TimeOfImpact', 'Box2D.Common.b2Settings', 'Box2D.Dynamics.Contacts.b2ContactEdge', 'Box2D.Dynamics.b2BodyDef']);
goog.addDependency('../../../src/dynamics/contacts/b2ContactConstraint.js', ['Box2D.Dynamics.Contacts.b2ContactConstraint'], ['Box2D.Common.Math.b2Mat22', 'Box2D.Common.Math.b2Vec2', 'Box2D.Dynamics.Contacts.b2ContactConstraintPoint']);
goog.addDependency('../../../src/dynamics/contacts/b2ContactConstraintPoint.js', ['Box2D.Dynamics.Contacts.b2ContactConstraintPoint'], ['Box2D.Common.Math.b2Vec2']);
goog.addDependency('../../../src/dynamics/contacts/b2ContactEdge.js', ['Box2D.Dynamics.Contacts.b2ContactEdge'], []);
...
goog.addDependency('../../../src/dynamics/contacts/b2ContactResult.js', ['Box2D.Dynamics.Contacts.b2ContactResult'], ['Box2D.Collision.b2ContactID', 'Box2D.Common.Math.b2Vec2']);
...
goog.addDependency('../../../src/dynamics/controllers/b2Controller.js', ['Box2D.Dynamics.Controllers.b2Controller'], ['Box2D.Dynamics.Controllers.b2ControllerEdge']);
goog.addDependency('../../../src/dynamics/controllers/b2ControllerEdge.js', ['Box2D.Dynamics.Controllers.b2ControllerEdge'], []);
